namespace Boom
{
    ...
    internal static class EntityUtil
    {
        ...
        public static bool TryQueryEntities<T>(EntityFilter.Base entityFilter, out LinkedList<T> entities, Func<DataTypes.Entity, T> getter, string sourceWorldId = default)
        {
        ...
        public static bool TryGetFieldAsString(string uid, string entityId, string fieldName, out string outValue, string defaultValue = default, string sourceWorldId = default)
        {
        ...
        public static bool TryGetFieldAsULong(string uid, string entityId, string fieldName, out ulong outValue, ulong defaultValue = default, string sourceWorldId = default)
        {
        ...
        public static bool TryGetFieldAsString(this DataTypes.Entity entity, string fieldName, out string outValue, string defaultValue = default)
        {
        ...
        public static bool TryGetFieldAsULong(this DataTypes.Entity entity, string fieldName, out ulong outValue, ulong defaultValue = default)
        {
            return TryGetFieldAs<ulong>(entity, fieldName, out outValue, defaultValue);
        }
        //
        public static bool TryGetEditedFieldAsNumeber(this EntityOutcome newEntityValues, string fieldName, out double outValue, double defaultValue = default)
        {
            outValue = defaultValue;
        ...
        public static bool TryGetEditedFieldAsText(this EntityOutcome newEntityValues, string fieldName, out string outValue, string defaultValue = default)
        {
            outValue = defaultValue;
        ...
        public static bool TryGetEditedFieldAsOldText(this EntityOutcome newEntityValues, string fieldName, out string outValue, string defaultValue = default)
        {
            outValue = defaultValue;
        ...
        public static bool TryGetEditedFieldAsNewText(this EntityOutcome newEntityValues, string fieldName, out string outValue, string defaultValue = default)
        {
            outValue = defaultValue;
